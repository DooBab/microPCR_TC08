...
BOOL CTempGraphDlg::OnInitDialog()
{
	...
	m_Graph.InitData(1, L"온도", 118, 26, RGB(255,0,0), true);
	m_Graph.InitData(2, L"온도", 118, 26, RGB(0,255,0), false );
...
void CTempGraphDlg::addData(float data, float data2)
{
	m_Graph.LineAdd(1, data);
	m_Graph.LineAdd(2, data2);
	m_Graph.DrawRect();
}
